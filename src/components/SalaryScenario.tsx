 ...
 * - CPP cash reduces net (shown separately), but "taxes" exclude CPP (your convention)
 * - Supports retained earnings
 * - 2025 Fed + BC brackets
 * - BPA credits (fed + BC)
...
const CPP_YAMPE = 81_200;  // Tier 2 ceiling (2025)  ← corrected
...
export function calculateIncorporatedSalary(params: {
  ...
  const corpCPPDeduct = solved.cpp?.corporateDeduction ?? 0; // equals corporateCPP here
  ...
  const totalTaxes    = personalTaxes + corporateTaxes;            // CPP excluded (your convention)
  ...
  return (
    <div className="rounded-2xl border border-white/10 bg-slate-900/60 p-4">
      ...
      <div className="mt-3 text-xs text-slate-400 border border-white/10 rounded-xl p-3 bg-slate-900/50">
        ...
        ER base/enhanced/CPP2 deducted corporately. CPP is excluded from “taxes” here but reduces take-home.
