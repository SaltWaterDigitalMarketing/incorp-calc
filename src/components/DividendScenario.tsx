...
export function calculateIncorporatedDividends(params: {
  ...
  // Totals/ratios (CPP = 0 in dividend-only)
  const totalCPP = 0;
  ...
  return (
    <div className="rounded-2xl border border-white/10 bg-slate-900/60 p-4">
      ...
      <div className="mt-3 text-xs text-slate-400 border border-white/10 rounded-xl p-3 bg-slate-900/50">
        ...
        amount, with BPA credits combined as non-refundable credits at each level.
        AMT/other credits are ignored. Dividends do not trigger CPP.
      </div>
